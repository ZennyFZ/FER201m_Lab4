    ...
    return (
      ...
      <Collapsible accordion>
        <CollapsibleItem
          ...
          node="div"
        >
          Our website is a home to the shows and films that everyone is talking about, from groundbreaking series and documentaries to the biggest blockbuster movies ever made.
        </CollapsibleItem>
        <CollapsibleItem
          expanded={false}
          header="Our Mission"
